...
<li>
<p>一个卡片:</p>
<VPCard v-bind='{"title":"yanwei","desc":"Where there is light, there is hope","logo":"https://mister-hope.com/logo.svg","link":"https://somecore.cn","background":"rgba(253, 230, 138, 0.15)"}' /></li>
</ul>
</div></template>

...
`)},Le=(e,t=!0)=>n=>(t&&xe(e),n.env.isDebug&&r.info("Options:",e),$(n,{id:"hope"}),{name:D,define:Ee(e),extendsBundlerOptions:(a,l)=>{e?.components?.includes("ArtPlayer")&&H(a,l,"artplayer"),e?.components?.includes("VidStack")&&K(a,l,/^media-/),_(a,l,["@vuepress/helper","vuepress-shared"])},clientConfigFile:a=>Be(a,e)});export{z as AVAILABLE_SERVICES,c as SHARE_CONFIG,Le as componentsPlugin,x as pdfLocaleConfig,E as siteInfoLocaleConfig,B as vidstackLocales};

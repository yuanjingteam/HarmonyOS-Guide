import{decodeData as v}from"@vuepress/helper/client";import{useMutationObserver as y}from"@vueuse/core";import{defineComponent as j,shallowRef as d,ref as u,computed as S,onMounted as w,watch as C,h as a}from"vue";import{LoadingIcon as b}from"vuepress-shared/client";import"../styles/chart.scss";import{g as m}from"../getDarkmodeStatus-DQ0CDr6h.js";const A=(e,r)=>r==="json"?JSON.parse(e):new Function(`let config,__chart_js_config__;
{
${e}
